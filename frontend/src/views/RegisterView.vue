  ...
  >
    ...
    <form className="fieldset" @submit.prevent="handleSubmit">
      ...
      <ul class="password-rules">
        <li :class="{ valid: mdpRules.length }">Au moins 8 caractères</li>
        <li :class="{ valid: mdpRules.uppercase }">Une majuscule</li>
        <li :class="{ valid: mdpRules.lowercase }">Une minuscule</li>
        <li :class="{ valid: mdpRules.digit }">Un chiffre</li>
      </ul>
      <div>
